...
class ClientNetwork {
  constructor({ onStatus, onMessage, onError }) { this.onStatus = onStatus; this.onMessage = onMessage; this.onError = onError; this.connection = null; this.reliable = null; }
  ...
  close(report = true) { if (this.connection) this.connection.close(); this.connection = null; this.reliable = null; if (report) this.onStatus('IDLE'); }
}
